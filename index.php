...
<a class="container-fluid nav-link d-none d-lg-block p-0 m-0" href="#"><img src="images/footerGrafikL.png"
                                                                            alt="largemap"></a>

<footer class="footer container-fluid bg-navfarve justify-content-center" style="max-height: 200px">

    <div class="row d-flex justify-content-around">
        <div class="col col-lg-3">
            <a class="nav-link active p-2" style="font-size: x-large" href="">Info</a>
            <a class="link p-2" style="font-size: large" href="#">Gården</a>
            <a class="link p-2" style="font-size: large" href="#">Click & collect</a>
            <a class="link p-2" style="font-size: large" href="#">Fødevarestyrelsen</a>
            <a class="link p-2" style="font-size: large" href="#">Cookies</a>
            <a class="link p-2" style="font-size: large" href="#">Bæredygtighed</a>
        </div>
        <div class="col col-lg-3">
            <a class="nav-link active p-2" style="font-size: x-large" href="">Åbningstider</a>
            <a class="link p-2" style="font-size: large" href="#">Mandag - fredag 11.00 - 19:00</a>
            <a class="link p-2" style="font-size: large" href="#">Søndag & helligedage 12.00 - 16.00</a>
        </div>
        <div class="col col-lg-3">
            ...
            <div class="row">
                <a class="nav-link col-1" href="#"><img src="images/Facebook.png" alt="Facebook"></a>
                <a class="nav-link col-1" href="#"><img src="images/Instagram.png" alt="instgram"></a>
            </div>
        </div>
    </div>
</footer>
