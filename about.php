...
<main>
        ...
        <div class="container mx-auto">
            <div class="row mx-auto about-graphic">
                ...
                <div class="col-6 col-lg-3 py-5 about-card1">
                    <a href="#cowgraphic"><img class="mx-auto" src="images/cowgraphic.png"></a>
                    <h5>Friluftsdyr</h5>
                ...
                <div class="col-6 col-lg-3 py-5 about-card2">
                    <a href="#shopgraphic"><img class="mx-auto" src="images/shopgraphic.png"></a>
                    <h5>Gårdbutik</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis lectus quis sem lacinia nonummy. </p>
                </div>

                <div class="col-6 col-lg-3 py-5 about-card3">
                    <a href="#naturegraphic"><img class="mx-auto" src="images/leafgraphic.png"></a>
                    <h5>Natur</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis lectus quis sem lacinia nonummy. </p>
                </div>

                <div class="col-6 col-lg-3 py-5 about-card4">
                    <a href="#tractorgraphic"><img class="mx-auto" src="images/tractorgraphic.png"></a>
                    <h5>Redskaber</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis lectus quis sem lacinia nonummy. </p>
                </div>
            </div>
    ...
    <section>
        <div class="container-fluid bg-lightGreen section-top">
           <div class="row section-top-title">
               <div class="col">
                   <a id="cowgraphic"><img class="w-25 mx-auto" src="images/cowgraphic.png"></a>
            ...
            <div class="container">
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-lg-6">
                        <img class="chewingcow mx-auto mb-4" src="images/aboutchewingcow.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container-fluid bg-dustyGrey section-top">
            <div class="row section-top-title">
                <div class="col">
                    <a id="shopgraphic"></a> <img class="w-25 mx-auto" src="images/shopgraphic.png"></a>
            ...
            <div class="container">
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-lg-6">
                        <img class="farmshop mx-auto mb-4" src="images/farmshopaboutimg.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container-fluid bg-dustyGreen section-top">
            <div class="row section-top-title">
                <div class="col">
                    <a id="naturegraphic"><img class="w-25 mx-auto" src="images/leafgraphic.png"></a>
            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-12">
                        <img class="natureabout mx-auto mb-4" src="images/aboutnatureimg.png">
                    </div>
    ...
    <section>
        <div class="container-fluid bg-lightBlue section-top">
            <div class="row section-top-title">
                <div class="col">
                    <a id="tractorgraphic"><img class="w-25 mx-auto" src="images/tractorgraphic.png"></a>
            ...
            <div class="container">
                <div class="row mt-5">
                    ...
                    <div class="col-12">
                        <img class="natureabout mx-auto mb-4" src="images/abouttractor1img.png">
                    </div>
                </div>
            </div>
        </div>
